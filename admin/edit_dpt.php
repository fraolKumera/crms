...
if(isset($_REQUEST['id'])){
    ...
    $sql="SELECT * FROM depatments WHERE id=$id";
                 ...
                 <div class="modal-body" >
                    <form  class="form-horizontal" enctype="multipart/form-data" id="register_form" method="POST">
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                            <input type="hidden" class="form-control" name="id" id="id" value="<?php echo $id;?>">  
                                Department Name :<input type="text" class="form-control" name="Service_name" id="Service_name" value="<?php echo $Service_name;?>"> 
                            </div>                                 
                          </div>  
